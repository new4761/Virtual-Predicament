...
public class GvrReticlePointer : GvrBasePointer {
	...
	public const float RETICLE_GROWTH_ANGLE = 1f;
	...
	public void UpdateDiameters() {
		...
		ReticleInnerDiameter = Mathf.Lerp(ReticleInnerDiameter, inner_diameter, Time.unscaledDeltaTime * reticleGrowthSpeed);
		ReticleOuterDiameter = Mathf.Lerp(ReticleOuterDiameter, outer_diameter, Time.unscaledDeltaTime * reticleGrowthSpeed);
